...
type
 ...
 public
   ...
   // procedure RefreshGambar(bmp:Tbitmap;var paintbox:Tpaintbox;Rect1,rect2:Trect);
 end;
 ...
 public
   ...
   procedure MousePointingM(var x,y:integer;EventKe:integer;var paintbox:TPaintbox);
 ...
 public
   ...
   procedure OpenFileAnimasi(var progress:TProgressbar;filename:string;var Listscenario:Tlist;var filepath,filesound:string);
 end;

 PreviewAnim = class
 public
   procedure Line(x1, y1, x2, y2:integer;color: TColor;var paintbox1:TPaintbox);
   procedure MoveObject(interval:integer;geser:boolean;textstring:tstringlist;Region:Trect;eventke,x1, y1, x2, y2:integer;bmpmouse,bmp:Tbitmap;var objek: TRect;var paintbox1,paintbox2:TPaintbox);
   procedure MoveRegion(interval:integer;item:listofimage;itempointer:listofpointer;eventke,x1, y1, x2, y2:integer;var bmp:Tbitmap;var Rect1,rect2: TRect;var paintbox1,paintbox2:TPaintbox);
   procedure AnimationExecute(intervalRect,intervalCur:integer;bergerak:boolean;var Rect1,rect2: TRect;var paintbox1,paintbox2:TPaintbox;var imageku:Timage;image1,image2:listofimage;firstpos,secondpos:integer);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        classPointer.MousePointingM(xbawah,ybawah,i+1,paintbox2);
      end;
    end;
  end;
  {*paintbox1.Refresh;*}
...
procedure Mousepointer.MousePointingM(var x,y:integer;EventKe:integer;var paintbox:TPaintbox);
var
  TextRect:TRect;
begin
 try
...
(* BRESLINE ALGORITHM : prosedure umum menggambar garis *)
procedure previewAnim.MoveObject(interval:integer;geser:boolean;textstring:tstringlist;Region:Trect;eventke,x1, y1, x2, y2:integer;bmpmouse,bmp:Tbitmap;var objek: TRect;var paintbox1,paintbox2:TPaintbox);
(*I.S : x1,y1,y2,y2,tb,color terdefinisi        *)
(*F.S : garis dengan titik awal (x1,y1) dan ti- *)
(*      tik akhir (x2,y2) tergambar di layar de-*)
(*      color color                             *)
...
begin
  ...
  for i := 1 to numpixels do
    begin
        ...
        classCursor.MousePointingM(xbawah,ybawah,eventke+1,paintbox2);
        {************************************************************}
      ...
      {**************************************************************}
      classCursor.MousePointingM(xbawah,ybawah,eventke,paintbox2);
...
procedure previewAnim.MoveRegion(interval:integer;item:listofimage;itempointer:listofpointer;eventke,x1, y1, x2, y2:integer;var bmp:Tbitmap;var Rect1,rect2: TRect;var paintbox1,paintbox2:TPaintbox);
(*I.S : x1,y1,y2,y2,tb,color terdefinisi        *)
(*F.S : garis dengan titik awal (x1,y1) dan ti- *)
(*      tik akhir (x2,y2) tergambar di layar de-*)
(*      color color                             *)
  ...
  for i := 1 to numpixels do
    begin
        ...
        begin
          ...
          xbawah:= itempointer.PointerFirstPos.X div 4;
          ybawah:= itempointer.PointerFirstPos.Y div 4;
          classPointer.MousePointingM(xbawah,ybawah,eventke+1,paintbox2);
        end;
        sleep(interval);
      (*langkah selanjutnya*)
...
procedure PreviewAnim.AnimationExecute(intervalRect,intervalCur:integer;bergerak:boolean;var Rect1,rect2: TRect;var paintbox1,paintbox2:TPaintbox;var imageku:Timage;image1,image2:listofimage;firstpos,secondpos:integer);
var
...
begin
 ...
 begin
   ...
   begin
     ...
     MoveRegion(intervalrect,image1,itempointer1,firstpos,middle1.X,middle1.y,middle2.X,middle2.Y,image1.imagefile,rect1,rect2,paintbox1,paintbox2);
     ...
     MoveObject(intervalcur,false,itempointer2.PointerText,rect2,firstpos,screenpoint1.X,screenpoint1.Y,screenpoint2.X,screenpoint2.Y,itempointer2.PointerFile,image1.ImageFile,rectku,paintbox1,paintbox2);
   end else
   begin
     ...
     begin
       ...
       begin
         ...
         MoveObject(intervalcur,true,itempointer1.PointerText,rect2,firstpos,screenpoint1.X,screenpoint1.Y,screenpoint2.X,screenpoint2.Y,itempointer1.PointerFile,image1.ImageFile,rectku,paintbox1,paintbox2);
         ...
         begin
           ...
           classPointer.MousePointingM(xbawah,ybawah,secondpos+1,paintbox2);
         end;
       end;
     end else
...
procedure fileop.OpenFileAnimasi(var progress:TProgressbar;filename:string;var Listscenario:Tlist;var filepath,filesound:string);
var
  fileAnimasi:TextFile;
  s:string;
  item:ListofImage;
